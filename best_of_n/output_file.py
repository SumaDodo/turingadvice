...
def main(_):
    FLAGS = _define_flags()
    FLAGS(sys.argv)
    FINAL_OUTPUT_FILE = os.path.join(FLAGS.tmp_dir, "Output_1N.txt")
    TMP_REPEATS_PATH = os.path.join(FLAGS.tmp_dir, "BoN-repeats1.txt")
    OUTPUT_PRED_FILE = os.path.join(FLAGS.tmp_dir, "output_1N_2.tsv-1010000")
